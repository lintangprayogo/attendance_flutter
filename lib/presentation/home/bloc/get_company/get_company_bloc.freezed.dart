...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({CompanyResponseModel company});
}
...
abstract class _Success implements GetCompanyState {
  const factory _Success(final CompanyResponseModel company) = _$SuccessImpl;

  CompanyResponseModel get company;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'GetCompanyState.error(error: $error)';
  }
